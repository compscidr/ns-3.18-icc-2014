...
plot name1.'.csv' using 1:3:2:6:5:xticlabels(label1) with candlesticks title label1 xlabel "Number of Clients" ylabel label1 whiskerbars, \
  ''         using 1:4:4:4:4 with candlesticks lt -1 notitle, \
  name2.'.csv' using 1:3:2:6:5:xticlabels(label2) with candlesticks title label2 whiskerbars, \
  ''         using 1:4:4:4:4 with candlesticks lt -1 notitle
