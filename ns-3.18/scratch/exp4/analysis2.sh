...
inputdir1=$(dirname "$1");
inputname1=$(basename "$inputdir1");		# take the directory name of the approach as the title

inputdir2=$(dirname "$2");
inputname2=$(basename "$inputdir2");		# take the directory name of the approach as the title
