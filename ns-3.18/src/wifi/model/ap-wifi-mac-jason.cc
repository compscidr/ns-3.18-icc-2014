...
NS_LOG_COMPONENT_DEFINE ("ApWifiMacJason");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (ApWifiMacJason);

TypeId
ApWifiMacJason::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::ApWifiMacJason")
    .SetParent<RegularWifiMac> ()
    .AddConstructor<ApWifiMacJason> ()
    .AddAttribute ("BeaconInterval", "Delay between two beacons",
                   TimeValue (MicroSeconds (102400)),
                   MakeTimeAccessor (&ApWifiMacJason::GetBeaconInterval,
                                     &ApWifiMacJason::SetBeaconInterval),
                   MakeTimeChecker ())
    .AddAttribute ("BeaconGeneration", "Whether or not beacons are generated.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&ApWifiMacJason::SetBeaconGeneration,
                                        &ApWifiMacJason::GetBeaconGeneration),
                   MakeBooleanChecker ())
  ;
  return tid;
}

ApWifiMacJason::ApWifiMacJason ()
{
...
void
ApWifiMacJason::SetAddress (Mac48Address address)
{
...
void
ApWifiMacJason::SetBeaconGeneration (bool enable)
{
  ...
  if (!enable)
    ...
    {
      m_beaconEvent = Simulator::ScheduleNow (&ApWifiMacJason::SendOneBeacon, this);
    }
  m_enableBeaconGeneration = enable;
}

bool
ApWifiMacJason::GetBeaconGeneration (void) const
{
  NS_LOG_FUNCTION (this);
...
Time
ApWifiMacJason::GetBeaconInterval (void) const
{
  NS_LOG_FUNCTION (this);
...
void
ApWifiMacJason::SetWifiRemoteStationManager (Ptr<WifiRemoteStationManager> stationManager)
{
...
void
ApWifiMacJason::SetLinkUpCallback (Callback<void> linkUp)
{
...
void
ApWifiMacJason::SetBeaconInterval (Time interval)
{
...
void
ApWifiMacJason::StartBeaconing (void)
{
  NS_LOG_FUNCTION (this);
  SendOneBeacon ();
}
...
void
ApWifiMacJason::ForwardDown (Ptr<const Packet> packet, Mac48Address from,
                        Mac48Address to)
{
...
void
ApWifiMacJason::Enqueue (Ptr<const Packet> packet, Mac48Address to, Mac48Address from)
{
...
void
ApWifiMacJason::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
bool
ApWifiMacJason::SupportsSendFrom (void) const
{
  NS_LOG_FUNCTION (this);
  return true;
}
...
SupportedRates
ApWifiMacJason::GetSupportedRates (void) const
{
  NS_LOG_FUNCTION (this);
...
HtCapabilities
ApWifiMacJason::GetHtCapabilities (void) const
{
...
void
ApWifiMacJason::SendProbeResp (Mac48Address to)
{
...
void
ApWifiMacJason::SendAssocResp (Mac48Address to, bool success)
{
...
void
ApWifiMacJason::SendOneBeacon (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
  hdr.SetBeacon ();
  ...
  m_beaconEvent = Simulator::Schedule (m_beaconInterval, &ApWifiMacJason::SendOneBeacon, this);
}

void
ApWifiMacJason::TxOk (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
ApWifiMacJason::TxFailed (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
ApWifiMacJason::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
ApWifiMacJason::DeaggregateAmsduAndForward (Ptr<Packet> aggregatedPacket,
...
void
ApWifiMacJason::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
